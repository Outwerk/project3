...
export default function Footer() {
    return (
        <>
            <footer className="bg-white border border-t-teal-300">
                        ...
                        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4">
                            <div>
                                ...
                                <ul className="mt-6 space-y-4 text-sm">
                                    <li>
                                        <a href="#" className="text-gray-700 transition hover:opacity-75"> Wedding Photography and Videography</a>
                                    </li>

                                    <li>
                                        <a href="#" className="text-gray-700 transition hover:opacity-75"> Engagement Sessions </a>
                                    </li>

                                    <li>
                                        <a href="#" className="text-gray-700 transition hover:opacity-75"> Family and Maternity Portraits </a>
                                    </li>

                                    <li>
                                        <a href="#" className="text-gray-700 transition hover:opacity-75">Event Photography</a>
                                    </li>

                                    <li>
                                        <a href="#" className="text-gray-700 transition hover:opacity-75"> Commercial Photography </a>
                                    </li>
                                </ul>
                            </div>
                            ...
                            <div>
                                ...
                                <ul className="mt-6 space-y-4 text-sm">
                                    ...
                                    <li>
                                        <a href="#" className="text-gray-700 transition hover:opacity-75"> Bar/Bat Mitzvah </a>
                                    </li>
                                    <li>
                                ...
                                <ul className="mt-6 space-y-4 text-sm">
                                    <li>
                                        <div className='flex justify-center items-center gap-5 w-fit'>
                                            ...
                                            <p className="text-gray-700 ">19 Miller Road
                                    ...
                                    <li>
                                        <div className='flex justify-center items-center gap-5 w-fit'>
                                            <span><MdEmail /></span>
                                            <p className="text-gray-700 ">info@ljmorelli.com</p>
                                        </div>
                                    </li>
                                    ...
                                    <li>
                                        <div className='flex justify-center items-center gap-5 w-fit'>
                                            ...
                                            <p className="text-gray-700 ">516.942.7455</p>
                                        </div>
                                    </li>
                                </ul>
                            </div>
